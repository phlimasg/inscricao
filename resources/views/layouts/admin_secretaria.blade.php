    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="{{url('/home/secretaria')}}">Secretaria</a></li>
...
<div class="container-fluid text-left">
    <div class="row content">
        <div class="col-sm-2 sidenav">
            <p><a href="{{url('/home/avaliacao')}}">Listar datas de prova</a></p>
            <p><a href="{{url('/home/secretaria')}}">Lista de Presença</a></p>
            <p><a href="{{url('/home/secretaria/avaliacaodata')}}">Alterar data de prova</a></p>
